...
const TARGET_DATE = new Date('2026-06-23T00:00:01').getTime();
...
const TimerAudio = new Audio("Countdown Sound Effect.mp3");
TimerAudio.loop = true;
TimerAudio.volume = 0.8;

// 2. Audio Ledakan (Diputar sekali saat waktu habis)
const ExplosionAudio = new Audio("Efek Bom Meledak -Meme.mp3");
...
const BirthdayAudio = new Audio("HAPPY BIRTHDAY  Sad Piano Version.mp3");
...
const dataFoto = [
    { src: "2.jpeg", caption: "Happy Birthday Sayang 💕" },
    { src: "3.jpeg", caption: "Setiap tawa bersamamu adalah momen berharga." },
    { src: "WhatsApp Image 2026-06-22 at 14.54.33.jpeg", caption: "As long as you're smiling..." },
    { src: "WhatsApp Image 2026-06-22 at 14.54.34.jpeg", caption: "I'm happy. Stay happy, my love. 💖" }
];
